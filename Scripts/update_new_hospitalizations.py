...
for state in states:
    ...
    plt.bar(range(len(new_hospitalizations)), new_hospitalizations, color='b')
    ...
    plt.savefig(os.path.join("Graphs", "General", "New Hospitalizations", f"{state}.png"), bbox_inches='tight')
    # plt.show()
    plt.cla()
